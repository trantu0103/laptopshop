...
<div class="container">
    <div id="content">
      ...
      <form action="{{ route('muahang') }}" method="post" class="beta-form-checkout">
        @csrf
        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="form-block">
              ...
              <input type="email" id="email" name="email" required placeholder="expample@email.com">
            </div>
              ...
              <div class="your-order-body">
                <ul class="payment_methods methods">
                  <li class="payment_method_bacs">
                    <input id="payment_method_bacs" type="radio" class="input-radio" value="COD" name="payment_method" checked="checked" data-order_button_text="">
                  ...
                  <li class="payment_method_cheque">
                    ...
                    <div class="payment_box payment_method_cheque" style="display: none;">
                      ...
                      <br>- Chủ TK: Laptop Shop
                      <br>- Ngân hàng XXX, Chi nhánh XXX
                    </div>            
                  </li>
